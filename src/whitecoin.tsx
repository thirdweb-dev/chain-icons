...
const Whitecoin = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      className="st0"
      d="M28.8 17.7v2.6H36c-.1-.7-.1-1.9-.4-2.6h-6.8zM36 22h-8.5v2.6h8.1c.3-.8.3-1.9.4-2.6zM5.8 24.5h8.1v-2.6H5.4c.1.8.1 1.9.4 2.6zM5.8 17.7c-.1.7-.3 1.8-.4 2.6h7.2v-2.6H5.8z"
    />
    <path
      className="st0"
