...
const Aurora = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 236.9 226.1" xmlns="http://www.w3.org/2000/svg" {...props}>
    <linearGradient
      id="a"
    ...
    <path
      ...
      fill="url(#a)"
    />
    <path d="m6.4 140.4 110.4 77.8L114.3 10z" fill="url(#b)" />
    <path d="M115.9 137.4 7.2 139.5l-.8.9 110.4 77.8z" fill="url(#c)" />
