...
const BeefyFinance = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    >
      ...
      />
      <path d="M61.4 43.7c4.5 0 8.2-3.7 8.2-8.3S66 27 61.4 27c-4.5 0-8.2 3.7-8.2 8.3s3.7 8.4 8.2 8.4zM84.9 60.2c3.8 0 6.9-3.1 6.9-7s-3.1-7-6.9-7c-3.8 0-6.9 3.1-6.9 7s3.1 7 6.9 7zM61.6 69.8c3.8-.1 7.6.4 11.3.9h.3c.1-.6.1-1.1.1-1.7 0-6.2-4.9-11.2-11-11.2s-11 5-11 11.2c0 1.1.2 2.1.4 3.1 2.6-2.5 6.6-2.2 9.9-2.3z" />
